...
all_cell_types <- col_df$plt_names[col_df$plt_names != "L2/3"]
...
cowplot::save_plot(plot = anterior_plt, 
               filename = sprintf("%s/%s/Figure_YYY_spatial_scatterpie_allen_anterior_%s_%s.svg",
                                an_mouse, plt_dir, id_comp, id_nmf), 
               base_width = 16, 
               base_height = 12)

cowplot::save_plot(plot = posterior_plt, 
               filename = sprintf("%s/%s/Figure_YYY_spatial_scatterpie_allen_posterior_%s_%s.svg",
                                an_mouse, plt_dir, id_comp, id_nmf), 
               base_width = 16, 
               base_height = 12)
...
cell_types_metadata_mod <- c(all_cell_types[!all_cell_types %in% c("L2/3 IT Cdc14a", "L2/3 IT Cxcl14", "L2/3 IT Ndst4 Endou", "L2/3 IT Otof", "L2/3 IT Plch1")], "L2/3")
...
cowplot::save_plot(plot = general_cortex_plt,
                   filename = sprintf("%s/%s/general_cortex_spatial_scatterpie_allen_%s_%s.pdf",
                                    an_mouse, plt_dir, id_comp, id_nmf), 
                   base_width = 12, 
                   base_height = 9)
...
fig_2_ind <- cowplot::plot_grid(plotlist = append(
  list(NULL, NULL, cortex_arrange[[1]],
       NULL, NULL, cortex_arrange[[2]]), 
  cortex_arrange[3:8]),
                   nrow = 4,
                   ncol = 3)

cowplot::save_plot(filename = sprintf("%s/%s/Figure2_individual.pdf",
                                      an_mouse, plt_dir),
                   plot = fig_2_ind,
                   base_height = 9,
                   base_width = 13)
