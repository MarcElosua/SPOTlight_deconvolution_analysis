...
cowplot::save_plot(plot = anterior_plt, 
               filename = sprintf("%s/%s/Figure_YYY_spatial_scatterpie_allen_anterior_%s_%s.pdf",
                                an_mouse, plt_dir, id_comp, id_nmf), 
               base_width = 16, 
               base_height = 12)

cowplot::save_plot(plot = posterior_plt, 
               filename = sprintf("%s/%s/Figure_YYY_spatial_scatterpie_allen_posterior_%s_%s.pdf",
                                an_mouse, plt_dir, id_comp, id_nmf), 
               base_width = 16, 
               base_height = 12)
...
anterior_plt <- spatial_scatterpie(se_obj = brain_mod,
                 ...
                 cell_types_interest = cortex_layers_mod, 
                 pie_scale = 0.4) +
  scale_fill_manual(values = col_df[col_df$ct_names %in% cell_types_metadata_mod, "col_vector"],
