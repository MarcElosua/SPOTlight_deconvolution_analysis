...
cowplot::save_plot(filename = sprintf("%s/%s/Supplementary_Figure_FFF_topic_signatures_arrange_10_%s_%s_.pdf", 
                     an_mouse, plt_dir, id_comp, id_nmf_iter),
                  plot = topic_plt_arr,
                 base_width = 24,
                 base_height = 30)

cowplot::save_plot(filename = sprintf("%s/%s/Supplementary_Figure_FFF_topic_signatures_arrange_10_%s_%s_.svg", 
                     an_mouse, plt_dir, id_comp, id_nmf_iter),
                  plot = topic_plt_arr,
                 base_width = 24,
                 base_height = 30)
